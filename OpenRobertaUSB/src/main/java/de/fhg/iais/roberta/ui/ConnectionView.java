...
public class ConnectionView extends JFrame {
    ...
    private final JTextField password = new JTextField("nao");
    ...
    private final JPanel pnlRobotConnection = new JPanel();
    ...
    private void initGUI() {
        ...
        this.centerPanel.setPreferredSize(new Dimension(300, 550));
        ...
        this.robotIpDesc.setFont(new Font("Arial", Font.PLAIN, 14));
        this.robotIpDesc.setBackground(Color.white);
        this.robotIpDesc.setBorder(null);
        ...
        this.passwordDesc.setBorder(null);
        ...
        this.centerPanel.add(this.pnlRobotConnection);
        ...
        this.pnlRobotConnection.add(this.username);
        this.pnlRobotConnection.add(this.passwordDesc);
        this.passwordDesc.setText(this.messages.getString("password"));
        this.pnlRobotConnection.add(this.password);
